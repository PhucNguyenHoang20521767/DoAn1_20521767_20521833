    ...
    <div className="">
      ...
      <div className="w-[32rem] p-2 max-[512px]:w-full">
        ...
        >
          ...
          <div className="mb-1 p-1">
            ...
            <input
              ...
              {...register("email", {
                ...
                maxLength: {
                  value: 40,
                  message: "Email chỉ có thể nhỏ hơn 40 kí tự",
                },
              })}
              name="email"
              value={loginEmail}
          ...
          {errors.email && (
            <span>
              <p className="pl-1 text-red-700">Hãy nhập email</p>
            </span>
          )}
          ...
          {errors.password?.type === "minLength" && (
            <span>
              {" "}
              <p className="pl-1 text-red-700">Password ít nhất 8 kí tự</p>
            </span>
          )}
        ...
        <div className="mt-1 p-1">
          <button
            className="underline hover:font-bold hover:text-dark-2"
        ...
        <div className="position: relative p-1">
          ...
          <div className="flex w-full">
            <hr className="my-3 h-px w-full border-0 bg-black dark:bg-gray-700" />
            <span className="position: absolute left-1/2 -translate-x-1/2 bg-white px-3 font-medium text-gray-900 dark:bg-gray-900 dark:text-white">
              Hoặc
            </span>
          </div>

          {/* Login with another app */}
          <div className="mt-3 flex w-full flex-wrap items-center justify-between max-[410px]:justify-center ">
            <button className="flex w-5/12 items-center justify-center rounded-sm border border-secondary-2 px-2 py-1 shadow-sm hover:font-bold focus:ring focus:ring-secondary-4">
              <svg
                className="h-5 w-5 shrink-0 max-[410px]:hidden"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 512 512"
              >
                <path d="M504 256C504 119 393 8 256 8S8 119 8 256c0 123.78 90.69 226.38 209.25 245V327.69h-63V256h63v-54.64c0-62.15 37-96.48 93.67-96.48 27.14 0 55.52 4.84 55.52 4.84v61h-31.28c-30.8 0-40.41 19.12-40.41 38.73V256h68.78l-11 71.69h-57.78V501C413.31 482.38 504 379.78 504 256z" />
              </svg>
              <div className="pl-3 text-lg">Facebook</div>
            </button>
            <div></div>
