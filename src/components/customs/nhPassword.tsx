...
export const InputPassword: React.FC<IInputProps> = ({ showPassword, password, setPassword, setShowPassword, label, error }) => {
        return (
            <div className="mb-1 p-1 relative">
            <label htmlFor="password" className="font-semibold block text-gray-700">{label}:</label>
